...
| 7 | [ ] | **RQ07: Ontwerp functionaliteit** | Als opdrachtgever wil ik dat kan inzien wat het ontwerp is van de functionaliteit van het gehele programma is, zodat ik een duidelijk beeld heb over wat het structuur is van de programma doet. | <ul> <li> [ ] Architectuurontwerp maken. </li><li> [ ] Flowchart maken. </li> <li> [ ] Elektrisch schema maken. </li> </ul> | Structuur van het programma is duidelijk. | **2** |
...
| :----: | :---- | :---- | :---- | :---- | :----: |
| Klaar | Hoog | 2 | Camera onderzoeksverslag  | Dennis | 1 |
| Klaar | Hoog | 2 | Microcontroller onderzoeksverslag | Tom | 1 |
| Klaar | Hoog | 2 | Software onderzoeksverslag | Ali | 2 |
| Klaar | Hoog | 8 | Onderzoek motion-detectie | Fabio | 1 |
...
| Status | Prioriteit | Benodigde tijd (uren) | Taken | Wie? | User story |
| :----: | :---- | :---- | :---- | :---- | :----: |
| Klaar | Hoog | 3 | Probleemomschrijving maken  | Tom | - |
| Klaar | Hoog | 3 | Budget bepalen/pitchen  | Dennis, Ali | - |
| Klaar | Hoog | 12 | Testen van onderdelen | Tom, Fabio | 5 |
| Klaar | Hoog | 12 | Raspberry Pi OS configureren | Fabio | 5 |
| Klaar | Hoog | 12 | Onderdelen voor rondom de Raspberry Pi en camera's worden geprint | Fabio | 6 |
| Klaar | Hoog | 12 | Begin requirementsanalyse | Dennis | - |
| Klaar | Hoog | 6 | Mechatronisch ontwerp, Architectuur ontwerp, flow chart | Ali, Tom | 6, 7 |
...
| Status | Prioriteit | Benodigde tijd (uren) | Taken | Wie? | User story |
| :----: | :---- | :---- | :---- | :---- | :----: |
| [ ] | leeg | 3 | Requirements analyse afronden | Dennis | - |
| [ ] | leeg | 3 | Detectie-model toevoegen aan camera-feed en optimaliseren | Dennis, Fabio | 1, 3 |
| [ ] | leeg | 3 | Onderzoeken en beginnen met een punt te krijgen van de camera beelden in een 2D grafiek | Ali | 4 |
| [ ] | Hoog | 8 | Begin Test-rapport | Tom | - |
| [ ] | Hoog | 5 | Afstandsmethode onderzoeken, implementeren en testen | Fabio, Tom  | 3 |
