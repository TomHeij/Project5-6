...
class AIModel:
    ...
    def predict(self, captures):
        results = [self.model(captures[0], verbose=False, conf=self.confidence_threshold, imgsz=512), self.model(captures[1], verbose=False, conf=self.confidence_threshold, imgsz=512)]
        objects = [[], []]
